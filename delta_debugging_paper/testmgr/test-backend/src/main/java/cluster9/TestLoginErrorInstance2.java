...
public class TestLoginErrorInstance2 {
    ...
    public void testLogin()throws Exception{
        ...
        ResponseEntity<LoginResult> r = restTemplate.exchange("http://10.141.212.21:30070/login",HttpMethod.POST, requestEntity, LoginResult.class);
        ...
        if(loginNum > 0){
            ResponseEntity<LoginResult> r2 = restTemplate.exchange("http://10.141.212.21:30070/login",HttpMethod.POST, requestEntity, LoginResult.class);
            ResponseEntity<LoginResult> r3 = restTemplate.exchange("http://10.141.212.21:30070/login",HttpMethod.POST, requestEntity, LoginResult.class);
            ResponseEntity<LoginResult> r4 = restTemplate.exchange("http://10.141.212.21:30070/login",HttpMethod.POST, requestEntity, LoginResult.class);
            result = r4.getBody();

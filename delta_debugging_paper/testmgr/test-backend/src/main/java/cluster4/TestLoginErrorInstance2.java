...
public class TestLoginErrorInstance2 {
    ...
    public void testLogin()throws Exception{
        ...
        if(loginNum > 0){
            ResponseEntity<LoginResult> r2 = restTemplate.exchange("http://10.141.211.174:31112/login",HttpMethod.POST, requestEntity, LoginResult.class);
            ResponseEntity<LoginResult> r3 = restTemplate.exchange("http://10.141.211.174:31112/login",HttpMethod.POST, requestEntity, LoginResult.class);
            ResponseEntity<LoginResult> r4 = restTemplate.exchange("http://10.141.211.174:31112/login",HttpMethod.POST, requestEntity, LoginResult.class);
            result = r4.getBody();

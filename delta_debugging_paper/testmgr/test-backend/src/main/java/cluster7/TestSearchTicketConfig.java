...
public class TestSearchTicketConfig {
    ...
    public void test() throws Exception {
        ...
        try{
            Thread.sleep(10000);
            ResponseEntity<ArrayList<TripResponse>> r = restTemplate.exchange("http://10.141.211.162:30118/travel/query",HttpMethod.POST, requestEntity, new ParameterizedTypeReference<ArrayList<TripResponse>>(){});

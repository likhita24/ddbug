...
public class TestF12 {
    ...
    public void testLogin()throws Exception {
        ...
        ResponseEntity<Boolean> re = restTemplate.exchange(
                "http://10.141.211.162:30112/adminOrder/suspendOrder/shanghai/nanjing",
                HttpMethod.GET,
                requestEntity,
                Boolean.class);
        ...
        for (int i = 0; i < 10; i++) {
            ...
            ResponseEntity<CancelOrderResult> cancel = restTemplate.exchange(
                    "http://10.141.211.162:30185/cancelOrder/5ad7750b-a68b-49c0-a8c0-32776b067703",
                    HttpMethod.GET,
                    requestEntity,
    ...
    public void tearDown() throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            ResponseEntity<Boolean> cancel = restTemplate.exchange(
                    "http://10.141.211.162:30112/adminOrder/cancelSuspendOrder/shanghai/nanjing",
                    HttpMethod.GET,
                    requestEntity,
                    Boolean.class);
        }

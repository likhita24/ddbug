...
public class TestBookErrorConfig {
    ...
    public void setUp() throws Exception {
        ...
        baseUrl = "http://10.141.211.177:30443";
        trainType = "0";//all
    ...
    public void testBooking() throws Exception{
        ...
        WebElement ebsp = driver.findElement(By.id("travel_booking_startingPlace"));
        ebsp.clear();
        ebsp.sendKeys("Shang Hai");

        WebElement ebtp = driver.findElement(By.id("travel_booking_terminalPlace"));
        ebtp.clear();
        ebtp.sendKeys("Su Zhou");
